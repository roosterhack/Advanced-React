...
const Mutations = {
  ...
  async requestReset(parent, args, ctx, info) {
    ...
    const mailRes = await transport.sendMail({
      from: 'mySite@site.com',
      to: user.email,
      subject: 'Your password reset token',
      html: makeANiceEmail(
        `Your password reset token is here!  <a href="${process.env.FRONTEND_URL}/reset?resetToken=${resetToken}">Click here to reset</a>`
      )
    });
